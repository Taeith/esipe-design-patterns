...
interface_provided="fr.uge.poo.paint.canvas.CanvasFactory"
class_providing_the_interface="fr.uge.poo.paint.canvas.adapters.coolgraphics.CoolGraphicsCanvasFactory"
included_classes=("fr.uge.poo.paint.canvas.Canvas"
	"fr.uge.poo.paint.canvas.CanvasFactory" "$class_providing_the_interface")
